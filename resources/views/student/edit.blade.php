...
<div class="container">
    <form class="" role="form" method="POST" action="{{ route('student.update', $student->id) }}" enctype="multipart/form-data">
        ...
        {{ csrf_field() }}
         ...
         <div class="row">
            <div class="col-md-12">
                <div class="">
                <h3 class="">Editing Student : {{ $student->first_name }} {{ $student->last_name }}</h3>
                    </div>
                    <div class="">
                            <div class="row">
